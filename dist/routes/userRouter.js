...
const userController_copy_1 = require("../controllers/userController copy");
const router = (0, express_1.Router)();
const validate_user_1 = require("../schema/validate-middleware/validate_user");
// const validateMiddleware = (isLogin: boolean) => {
//   return (req: Request, res: Response, next: NextFunction) => {
//     const { email, password, password_re } = req.body;
//     let result;
 ...
 */
router.post("/signup", (0, validate_user_1.validateUserMiddleware)(false), userController_copy_1.postSignup);
/**
 * @swagger
 * /login:
 *   post:
 ...
 *         description: Validation error
 */
router.post("/login", (0, validate_user_1.validateUserMiddleware)(true), userController_copy_1.postLogin);
/**
 * @swagger
 * /getForgot:
 *   get:
 ...
 */
router.get("/getForgot", userController_copy_1.getForgotPassword);
/**
 * @swagger
 * /forgot:
 *   post:
 ...
 *         description: Validation error
 */
router.post("/forgot", validate_user_1.validateForgotPW, userController_copy_1.forgotPassword);
/**
 * @swagger
 * /resetPage/{token}:
 *   get:
 ...
 */
router.get("/resetPage/:token", userController_copy_1.resetPasswordPage);
/**
 * @swagger
 ...
 *         description: Validation error
 */
router.post("/reset-password/:token", userController_copy_1.resetPassword);
router.post("/logout", validate_user_1.validateHeaders, userController_copy_1.logout);
