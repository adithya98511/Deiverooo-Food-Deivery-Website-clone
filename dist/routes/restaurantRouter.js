 ...
 */
router.get('/restaurants', auth_middleware_1.authMiddleware, (0, role_middleware_1.roleMiddleware)('admin'), restaurantController_1.getRestaurants);
/**
 * @swagger
 * /createRestaurant:
 *   post:
 ...
 *         description: Forbidden - User does not have the right role
 */
router.post('/createRestaurant', auth_middleware_1.authMiddleware, (0, role_middleware_1.roleMiddleware)('admin'), restaurantController_1.postCreateRestaurant);
